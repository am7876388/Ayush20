$(document).ready(function() {
    $(document).on("click",".tags",function(){
      ...
      $(".container").remove();
      $(".data").remove();
      var num23 = $("<div></div>").addClass("data");
      var num24 = $("<img></img>").attr("id","image");
      num23.append(num24);
      var num25 = $("<h2></h2>");
      var num26 = $("<a></a>").attr("id","anchor");
      num25.append(num26);
      num23.append(num25);
      var num27 = $("<div></div>").addClass("numbers");
      var num28 = ["Followers","Following","Repos"];
      for(let i = 0; i < 3; i++){
      var num29 = $("<div></div>").attr("id",num28[i])
      num27.append(num29);
      }
      for(let j = 0; j < 3; j++){
      var num30 = $("<div></div>").addClass("numbers_data");
      num30.text(num28[j]);
      num27.append(num30);
      }
      num23.append(num27);
