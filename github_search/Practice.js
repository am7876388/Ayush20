    ...
    $("#Submit").click(function(){
        $(".data").css("opacity","1");
            var num1 = $("#Input input").val();
             num2 = "https://api.github.com/users/"+num1+"/repos";
             num5 = "https://api.github.com/users/"+num1+"/followers";
             num6 = "https://api.github.com/users/"+num1+"/following";
        fetchAll(num1);
                ...
                if(data.length <= 0){
                    ...
                    for(var i = 0; i < data.length; i++){
                        if(num13 < 5){
                            ...
                            $(num14).append(num15);
                            var num17 = $("<img></img>").addClass("Follow");
